...
model = UNet()
model.load_state_dict(torch.load("saved\\20250602_223253\\ckpt\\99.pth"))
# model = UNetDeconv()
# model.load_state_dict(torch.load("saved\\20250602_211047_deconv\\ckpt\\99.pth"))
...
def save(result, name):
    ...
    result = (torch.clip(result, 0.0, 1.0)+0.0)*255.0 / 1.0
